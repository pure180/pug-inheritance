...
(function() {
  ...
  Parser = (function() {
    function Parser(filename, directory, options) {
      ...
      this.pugWalkAstType = this.options.pugWalkAstType && typeof this.options.pugWalkAstType === 'string' ? this.options.pugWalkAstType : 'RawInclude';
      this.cache = {};
      this.files = {};
